...
SetShaderValue( shader, GetShaderLocation( shader, "screenDims" ), @screenDims( 0 ), UNIFORM_VEC2 )

SetShaderValue( shader, cLoc, @c( 0 ), UNIFORM_VEC2 )
SetShaderValue( shader, zoomLoc, @zoom, UNIFORM_FLOAT )
SetShaderValue( shader, offsetLoc, @offset( 0 ), UNIFORM_VEC2 )
